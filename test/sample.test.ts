...
describe("Harbor Sample Test", function () {
  ...
  it(
    "Checks if the Ethereum chain exists",
    async () => {
  ...
  it(
    "Checks if the Polygon chain exists",
    async () => {
  ...
  it(
    "Checks if the Offchain actors exists",
    async function () {
  ...
  it(
    "Assert and print sequencerSubscriber log",
    async function () {
      if (typeof testnetName === "string") {
